...
#define MOTOR_FAN_CHAN_MAX_SPEED                100
#define MOTOR_BRUSH_CHAN_MAX_SPEED              100
#define MOTOR_WHEEL_CHAN_MAX_SPEED              90

#define MOTOR_FAN_CHAN_STARTUP_SPEED            90
#define MOTOR_LWHEEL_CHAN_STARTUP_SPEED         40
#define MOTOR_RWHEEL_CHAN_STARTUP_SPEED         40
#define MOTOR_LBRUSH_CHAN_STARTUP_SPEED         60
#define MOTOR_RBRUSH_CHAN_STARTUP_SPEED         60
