...
enum {
    ...
    MEAS_CHAN_IFRD_BOTTOM_RX_L,                                                 // REV1.0 && REV1.1: front and center of one side pos are logic OR
    MEAS_CHAN_IFRD_BOTTOM_RX_R,                                                 // REV1.2: front and center of one side pos share one ADC Channel which is used by TDM via a analog switch.
#ifdef REVISION_1_0
...
#define AD_CHAN_TDM_SW_GPIO_PERIPH_ID   (RCC_APB2Periph_GPIOE)
#define AD_CHAN_TDM_SW_GPIO             GPIOE
#define AD_CHAN_TDM_SW_PIN              GPIO_Pin_13
#define AD_CHAN_TDM_SW_ON()             GPIO_SetBits(AD_CHAN_TDM_SW_GPIO, AD_CHAN_TDM_SW_PIN)
#define AD_CHAN_TDM_SW_OFF()            GPIO_ResetBits(AD_CHAN_TDM_SW_GPIO, AD_CHAN_TDM_SW_PIN)
#endif
