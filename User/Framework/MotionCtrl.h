...
#define IFRD_TxRx_LIGHT_NUM                 8
#elif defined REVISION_1_1
#define IFRD_TxRx_CHAN_NUM                  6                                   // 2 back lights of bottom are not used
#define IFRD_TxRx_LIGHT_NUM                 6
#elif defined REVISION_1_2
#define IFRD_TxRx_CHAN_NUM                  6                                   // Total:6, 2 channels are used in TDM
#define IFRD_TxRx_LIGHT_NUM                 8                                   // Total:8, bottom 4 lights use 2 channels in TDM
#endif
...
#define LBRUSH_CUR_THRESHOLD                    96                              //  0.16A
#define RBRUSH_CUR_THRESHOLD                    96                              //  0.16A
#define MBRUSH_CUR_THRESHOLD                    750                             //  1.0A
#define FAN_CUR_THRESHOLD                       1000                            //  1.2A
#elif defined REVISION_1_2
extern u16 _ADCRefVal;
#define LBRUSH_CUR_THRESHOLD                    (_ADCRefVal/15)                 //  0.16A
#define RBRUSH_CUR_THRESHOLD                    (_ADCRefVal/15)                 //  0.16A
#define MBRUSH_CUR_THRESHOLD                    (_ADCRefVal/2)                  //  1.2A
#define FAN_CUR_THRESHOLD                       (2*_ADCRefVal/3)                //  1.6A
#endif
...
#define COLLISION_DETECT_LEFT_PIN           GPIO_Pin_2                          /* hardware FL */
#define COLLISION_DETECT_FL_PIN             GPIO_Pin_3                          /* hardware SL */
...
#define WHEEL_FLOAT_DETECT_L_GPIO           GPIOE
#define WHEEL_FLOAT_DETECT_R_GPIO           GPIOD
#define WHEEL_FLOAT_DETECT_L_PIN            GPIO_Pin_8
#define WHEEL_FLOAT_DETECT_R_PIN            GPIO_Pin_15
...
#define WHEEL_ESCAPE_SPEED                  30
#define WHEEL_CRUISE_SPEED                  25
#define WHEEL_MODE_SPOT_SPEED               24
#define WHEEL_FAULT_PROC_SPEED              15
#define WHEEL_HOMING_SPEED                  10
...
#define PATH_FAULT_BOTTOM_FRONT_MASK        0x0202
#define PATH_FAULT_BOTTOM_SIDE_MASK         0x2020
#define PATH_FAULT_BOTTOM_SIDE_L_MASK       0x0020
#define PATH_FAULT_BOTTOM_SIDE_R_MASK       0x2000
